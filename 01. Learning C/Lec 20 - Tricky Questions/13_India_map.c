/* This code isn't for understanding. Compile. Execute. Wonder! */ 
...
{ 
    ...
    // The encoded string's, after removing first 31 characters, 
    // individual characters determine how many spaces 
